  ...
  <footer>
      <div class="footer">
          <ul class="clearfix">
              ...
              <li id="_myMember">
                  <p>
                      <img src="../resource/img/app/huiyuan.png">
                  </p>
                  <p>
                      <span>会员</span>
                  </p>
...
// 		  jalert.show($(this).text());
          location.href="./toMdPage?auth="+auth+"&type="+$(this).attr("data-type")+"&number="+$(this).attr("data-number");
	  });
	  //经营
	  ...
	  //会员
	  $("#_myMember").on("click",function(){
		  location.href="./toMemberData?auth="+auth;
	  });
	  //店铺
	  $("#_storeLink").on("click",function(){
